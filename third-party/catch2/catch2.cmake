set(CATCH2_VERSION "v3.15.1" CACHE STRING "Catch2 version")
...
string(REGEX REPLACE "^v" "" CATCH2_VERSION_BARE "${CATCH2_VERSION}")
...
if(NOT ${CATCH2_FORCE_BUILD})
  set(CATCH2_FIND_PACKAGE_ARGS FIND_PACKAGE_ARGS ${CATCH2_VERSION_BARE} EXACT CONFIG)
endif()
