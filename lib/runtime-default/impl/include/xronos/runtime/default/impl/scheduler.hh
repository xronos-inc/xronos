...
#ifndef XRONOS_RUNTIME_DEFAULT_IMPL_SCHEDULER_HH
#define XRONOS_RUNTIME_DEFAULT_IMPL_SCHEDULER_HH
...
#include "xronos/runtime/default/impl/safe_vector.hh"
...
public:
  explicit ReadyQueue(util::log::NamedLogger& log, std::ptrdiff_t num_workers)
...
#endif // XRONOS_RUNTIME_DEFAULT_IMPL_SCHEDULER_HH
