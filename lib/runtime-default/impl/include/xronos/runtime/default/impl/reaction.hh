...
#ifndef XRONOS_RUNTIME_DEFAULT_IMPL_REACTION_HH
#define XRONOS_RUNTIME_DEFAULT_IMPL_REACTION_HH
...
private:
  ...
  std::reference_wrapper<const core::ReactionProperties> reaction_properties_;
...
public:
  Reaction(const core::Element& element_info, Reactor& container);
  ...
  [[nodiscard]] auto priority() const noexcept -> auto { return reaction_properties_.get().position + 1; }
...
#endif // XRONOS_RUNTIME_DEFAULT_IMPL_REACTION_HH
