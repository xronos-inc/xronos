...
#ifndef XRONOS_RUNTIME_DEFAULT_IMPL_PORT_HH
#define XRONOS_RUNTIME_DEFAULT_IMPL_PORT_HH
...
class Port : public ReactorElement, public GettableTrigger, public SettableEffect {
private:
...
public:
  ...
  void set(const std::any& value) noexcept final;
  [[nodiscard]] auto get() const noexcept -> std::any final;
...
#endif // XRONOS_RUNTIME_DEFAULT_IMPL_PORT_HH
