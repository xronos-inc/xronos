...
#ifndef XRONOS_RUNTIME_VALUE_PTR_HH
#define XRONOS_RUNTIME_VALUE_PTR_HH
...
public:
  ...
  friend auto xronos::runtime::make_mutable_value(Args&&... args) -> xronos::runtime::MutableValuePtr<U>;
};
...
public:
  ...
  template <class U, class... Args>
  // NOLINTNEXTLINE(readability-redundant-declaration)
  friend auto xronos::runtime::make_immutable_value(Args&&... args) -> xronos::runtime::ImmutableValuePtr<U>;
};
